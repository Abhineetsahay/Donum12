  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[350px] max-w-full shrink-0 rounded-2xl border border-b-0 border-zinc-800 bg-[linear-gradient(135deg,#18182a_0%,#23234a_100%)] px-8 py-6 md:w-[450px] text-white"
            key={idx}
          >
            <blockquote>
              <div
